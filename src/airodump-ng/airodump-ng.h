...
#include "../../include/aircrack-ng/osdep/osdep.h"
#include "../../include/aircrack-ng/pcre/compat-pcre.h"
...
int dump_add_packet_wrapper(unsigned char * h80211,
							...
							struct rx_info * ri,
							int cardnum);
void update_rx_quality_wrapper(void);

int update_dataps_wrapper(void);
...
extern struct local_options lopt;
